...
//http://stackoverflow.com/a/14461609/4698963
function isInArray(friends, person) {
    return friends.indexOf(person.toLowerCase()) > -1;
}
			...
			$('[role="article"]').each(function(i) {
				...
				//if($(this).find("a").length){
					...
					if ($(this).find("[role=\"presentation\"]").length > 0){
						...
						console.log(name);
						console.log(friends);
						//Check to see if it's your friend
						if(isInArray(friends, name)){
